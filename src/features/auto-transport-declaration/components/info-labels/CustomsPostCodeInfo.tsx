  ...
  return (
    <div className="space-y-2 text-sm">
      ...
      <p>
        ...
        <span className="font-medium">{t('declarationForm.infoLabel.customsPostInfo.description2')}</span>{' '}
        {t('declarationForm.infoLabel.customsPostInfo.description3')}
      </p>

      <div className="rounded-md border border-border bg-muted/50 p-3">
        <p className="mb-1 font-medium">{t('declarationForm.infoLabel.customsPostInfo.exampleLabel')}</p>
