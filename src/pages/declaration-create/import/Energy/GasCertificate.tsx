...
export default function GasCertificate() {
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="text-gray-600">Energy resources - Gas certificate - Page coming soon...</p>
      ...
      <div className="mt-4 text-gray-500 text-sm">
        Path:
        /export-import-transit/create-declaration/import-transit/energy-resources/gas-certificate
      </div>
    </div>
  );
}
