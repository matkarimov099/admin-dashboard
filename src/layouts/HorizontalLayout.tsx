...
import { BreadcrumbNav } from '@/components/common/breadcrumb-nav.tsx';
...
import { FloatingSearchButton } from '@/components/custom/floating-search-button.tsx';
            ...
            <div className="flex min-h-0 min-w-0 flex-1 flex-col p-2 sm:gap-4 sm:p-4">
              ...
              >
                <AnimatePresence mode="wait">
                  ...
                  >
                    {/* Main content */}
                    <main className="flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto overflow-x-hidden rounded-lg">
                      <Outlet />
                    </main>
                  </motion.div>
                </AnimatePresence>
