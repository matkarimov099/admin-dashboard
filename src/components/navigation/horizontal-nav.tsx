    ...
    const renderMenuGroupPopover = (group: MenuGroupConfig) => {
        ...
        return (
            <Popover key={group.id}>
                ...
                <PopoverContent align="start" className="min-w-[var(--radix-popover-trigger-width)] w-fit p-0"
                                sideOffset={4}>
                    <div className="p-2">
        ...
        if (visibleChildren.length > 0) {
            ...
            return (
                <Popover key={item.id}>
                    ...
                    <PopoverContent align="start" className="min-w-[var(--radix-popover-trigger-width)] w-fit p-2"
                                    sideOffset={4}>
                        {/* Children */}
                        <div className="space-y-1">
                            {visibleChildren.map(child => (
                    ...
                    <div className="flex h-full flex-col">
                        ...
                        <div className="flex items-center gap-3 border-b p-4">
                            ...
                            >
                                ...
                                <span
                                    className="truncate font-bold font-sans text-(--color-primary) text-sm tracking-wide">
                  {t('app.name')}
                </span>
                            </LocalizedNavLink>
                        </div>
