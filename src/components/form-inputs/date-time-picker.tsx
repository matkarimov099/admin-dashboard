              ...
              <div className="flex items-center gap-2">
                ...
                {allowClear && date && (
                  <button
                    ...
                    className="-translate-y-1/2 absolute top-1/2 right-1 z-10 cursor-pointer rounded-sm bg-background opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    aria-label={'Clear'}
                  >
                    <X className="h-3 w-3" />
                  </button>
