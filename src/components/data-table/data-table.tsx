                        ...
                        {isLoading ? (
                                        ...
                                        (_, colIndex) => (
                                            <TableCell
                                                ...
                                                className={`
                                                      ...
                                                      ${colIndex === 1 && isScrolled ? `sticky left-0 z-30 bg-card border-r` : ''}
                                                    `}
                                            >
                            ...
                            table.getRowModel().rows.map((row, index) => (
                                <TableRow
                                    ...
                                    className={`transition-colors hover:bg-[var(--control-ghost-bg)] ${
                                        row.getIsSelected()
                                ...
                                >
                                    {row.getVisibleCells().map((cell, cellIndex) => (
                                        <TableCell
                                            key={cell.id}
                                            className={`
                                                border-border border-b border-l border-r text-left text-foreground
                                                transition-colors hover:bg-muted/50
                                                 ${cellIndex === 1 && isScrolled ? `sticky left-0 z-30 bg-card border-r` : ''}
                                              `}
                                            style={{
