...
export function NavUser({ user, logout }: NavUserProps) {
	...
	return (
		<div
			className={cn(
				'relative',
				'before:absolute before:inset-x-0 before:-top-3 before:h-px before:bg-gradient-to-r before:from-transparent before:via-[var(--border)]/50 before:to-transparent'
			)}
		>
			<SidebarMenu>
				<SidebarMenuItem>
