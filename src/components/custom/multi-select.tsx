			...
			<Popover open={isOpen} onOpenChange={setIsOpen}>
				<PopoverTrigger asChild>
					<Button
						...
						{...props}
					>
						<div className="flex-1 py-2 pr-8 text-left">
							{selectedValues.length === 0 ? (
								<span className="block text-left text-sm">{placeholder}</span>
							) : (
								<div className="flex flex-wrap items-center gap-1 overflow-hidden">
										...
										return (
											...
											>
												...
												<button
													...
													className="cursor-pointer rounded-sm border-0 bg-transparent p-0.5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500"
									...
									{selectedValues.length > 0 && (
										<button
											...
											className="ml-1 h-4 w-4 cursor-pointer rounded-sm text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500"
